...
import { LayoutDashboard, ShieldAlert, Globe, BookOpen, FileText, Briefcase, Lightbulb, Settings, X, Zap } from 'lucide-react';
...
const AntiRiskLogo = ({ className = "w-10 h-10" }: { className?: string }) => (
  <svg viewBox="0 0 100 100" className={className} xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M5 85 L25 85 L15 65 Z" fill="#dc2626" />
...
const Navigation: React.FC<NavigationProps> = ({ 
  ...
  const navItems = [
    ...
    { id: View.SOCIAL_TRENDS, label: 'Trending Intelligence', icon: Zap },
      ...
      <div className={`${baseClasses} ${mobileClasses}`}>
        <div className="h-full flex flex-col">
            ...
            {navItems.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {item.id === View.SOCIAL_TRENDS && socialBadge > 0 && (
                    <span className="bg-emerald-500 text-white text-[10px] font-black px-2 py-1 rounded-lg">
                      {socialBadge}
                    </span>
                  )}
          ...
          <div className="p-8 border-t border-slate-800/40 space-y-6">
            ...
            >
              <Settings size={24} />
              <span className="font-bold text-lg">Alert Settings</span>
            </button>
            <div className="bg-slate-900/30 rounded-3xl p-6 border border-slate-800/40">
              ...
              <div className="flex items-center gap-3">
                <span className="w-2.5 h-2.5 rounded-full bg-green-500 animate-pulse shadow-[0_0_100px_rgba(34,197,94,0.5)]"></span>
